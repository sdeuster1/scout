...
export default function UploadTranscript() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-lg font-medium text-[#fffbf4] mb-5">Upload call transcript</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg bg-[#1A2D42] border border-white/[0.08] px-4 py-3 text-[13px] text-[#fffbf4] placeholder-[#556677] focus:outline-none focus:ring-1 focus:ring-[#c4b1f9] focus:border-transparent resize-none"
            />
            <label className="inline-flex items-center gap-1.5 mt-2 text-[12px] text-[#8899AA] cursor-pointer hover:text-[#fffbf4]">
              📎 Upload .txt file
              <input
                ref={fileRef}
                type="file"
          ...
          <button
            ...
            className="w-full py-2.5 rounded-lg text-[13px] font-medium bg-[#c4b1f9] text-[#0B1B2B] hover:bg-[#b39df7] disabled:opacity-30 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
        ...
        <div className="space-y-4">
          <div className="bg-[#1A2D42] rounded-xl border border-white/[0.08] p-5">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-[#c4b1f9] text-lg">✓</span>
              <h3 className="font-medium text-[#fffbf4] text-[14px]">Transcript analyzed and stored</h3>
            </div>
...
function Field({ label, value }) {
  return (
    <div>
      ...
      <p className="text-[13px] text-[#fffbf4] mt-0.5">{value || '—'}</p>
    </div>
  )
}
